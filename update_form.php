	...
	<br>
		...
		<form class="form-horizontal" method="POST" action="envia.php" enctype="multipart/form-data">
		  <fieldset>
			...
			$link = mysqli_connect('popmps.mysql.dbaas.com.br','popmps','Admin123','popmps');

			$id = $_GET["id"];

			// Seleciona o Banco de dados através da conexão acima

			$sql = "SELECT id,numero,ano,titulo,categoria, data_public, anexo FROM publicacao WHERE ID = '$id'";
			...
			<div class="form-group">
			  <label class="col-md-4 control-label" for="numero"><font size="2">Número</font></label>  
				<div class="col-md-4">
				  <input id="numero" name="numero" placeholder='<?php .$registro["numero"]. ?>' class="form-control input-md" required="true" type="number">
				</div>
			</div>
