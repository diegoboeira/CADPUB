...
/* Upload do Arquivo para armazenamento no Server e Gravação das informações no banco  */
		...
		$query = "UPDATE publicacao SET numero = $numero, ano = $ano, titulo = $titulo, categoria = $categoria, data_public = $data_public, resumo = $resumo, anexo = $novo_nome, usuario = $usuario WHERE ID = $id";
